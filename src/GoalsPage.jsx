...
import { MdSettings, MdAdd, MdCheckCircle, MdEdit, MdDelete } from 'react-icons/md';
    ...
    return (
        <Box p={6} shadow="md" borderWidth="1px" borderRadius="md" bg="white">
            ...
            <Text mt={4} fontSize="sm" color="gray.700" textAlign="center">
                Define your marketing goals and track your progress. Stay focused on your objectives
