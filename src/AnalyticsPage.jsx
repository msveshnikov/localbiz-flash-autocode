    ...
    return (
        <Box p={6} bg={useColorModeValue("gray.50", "gray.800")}>
            <Flex justifyContent="space-between" alignItems="center" mb={4}>
                ...
                <Button leftIcon={<Icon as={MdDownload} size="sm" />} colorScheme="blue">
                    Export Report
                </Button>
            </Flex>
            ...
            <TableContainer bg="white" shadow="sm" borderRadius="md" borderWidth="1px">
                <Table variant="simple">
                    <TableCaption>
                        Detailed analytics to understand campaign performance and identify areas for improvement.
                    </TableCaption>
                    <Thead>
                        <Tr>
                            <Th>Campaign</Th>
